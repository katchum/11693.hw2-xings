...
public class Gene_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.xings.types.Gene");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "edu.cmu.xings.types.Gene");
  ...
  public int getStart(int addr) {
      ...
      jcas.throwFeatMissing("start", "edu.cmu.xings.types.Gene");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "edu.cmu.xings.types.Gene");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "edu.cmu.xings.types.Gene");
